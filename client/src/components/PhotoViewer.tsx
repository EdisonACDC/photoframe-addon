...
export type TransitionEffect = "mix" | "fade" | "slideLeft" | "slideRight" | "slideUp" | "slideDown" | "zoomIn" | "zoomOut" | "kenBurns" | "rotate" | "flip" | "spiral" | "corner" | "bounce" | "swing" | "blur" | "glide" | "collapse" | "whirl";
...
const transitionVariants = {
  ...
  swing: {
    initial: { opacity: 0, rotateY: -60, transformOrigin: "top" },
    animate: { opacity: 1, rotateY: 0, transformOrigin: "top" },
    exit: { opacity: 0, rotateY: 60, transformOrigin: "top" },
  },
  blur: {
  ...
  glide: {
    initial: { opacity: 0, x: "80%", rotate: 15, scale: 0.9 },
    animate: { opacity: 1, x: 0, rotate: 0, scale: 1 },
    exit: { opacity: 0, x: "-80%", rotate: -15, scale: 0.9 },
  },
  collapse: {
    initial: { opacity: 0, scaleY: 0, scaleX: 1.2 },
    animate: { opacity: 1, scaleY: 1, scaleX: 1 },
    exit: { opacity: 0, scaleY: 0, scaleX: 1.2 },
  },
  whirl: {
    initial: { opacity: 0, rotate: -540, scale: 0.2 },
    animate: { opacity: 1, rotate: 0, scale: 1 },
    exit: { opacity: 0, rotate: 540, scale: 0.2 },
  },
};

type ActualEffect = Exclude<TransitionEffect, "mix">;
const effectOptions: ActualEffect[] = ["fade", "slideLeft", "slideRight", "slideUp", "slideDown", "zoomIn", "zoomOut", "kenBurns", "rotate", "flip", "spiral", "corner", "bounce", "swing", "blur", "glide", "collapse", "whirl"];
