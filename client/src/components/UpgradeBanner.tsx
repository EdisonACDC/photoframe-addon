        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1 space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              {daysRemaining > 1 
                ? `${daysRemaining} giorni rimasti - Cestino drag & drop attivo!`
                : `Ultimo giorno! Sblocca PRO per mantenere il cestino`
              }
            </p>
          </div>
      ...
      <Card className="p-4 bg-gradient-to-r from-destructive/10 via-destructive/5 to-transparent border-destructive/20">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1 space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Acquista PhotoFrame PRO per sbloccare Cestino drag & drop avanzato
            </p>
          </div>
