...
const effects: { value: TransitionEffect; label: string; isPro?: boolean }[] = [
  ...
  { value: "swing", label: "🎪 Dondolio" },
  { value: "blur", label: "💫 Sfocatura" },
  { value: "glide", label: "✈️ Planata" },
  { value: "collapse", label: "📏 Collasso" },
  { value: "whirl", label: "🌪️ Vortice" },
];
              ...
              <div className="space-y-8">
                ...
                <div className="pt-4 border-t border-border">
                  ...
                  <p className="text-xs text-green-600 mt-3">
                    ✨ Versione BETA: Tutti i 19 effetti disponibili gratuitamente!
                  </p>
                </div>
